...
public class TestConfig{
	...
	public static String from = "onwumerebright.nttdata@gmail.com";
	public static String password = "okey##0104";
	public static String[] to ={"onwumere.bright@gmail.com","brighthamza9@yahoo.com"};
